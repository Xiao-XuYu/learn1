...
选项D：可比性要求企业采用一致的会计政策，本题未体现。`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["总论","会计信息质量要求的应用"]},{chapterId:"ch01",sectionId:"s01-04",kpointIds:["kp-ch01-s01-04-x4y1"],type:"single",prompt:"【2.3 会计要素的辨析】下列各项中，不属于企业资产特征的是（ ）。",options:[{id:"A",text:"企业拥有或控制"},{id:"B",text:"预期会导致经济利益流出企业"},{id:"C",text:"由过去的交易或事项形成"},{id:"D",text:"能够可靠计量其成本"}],answer:"B",explanation:`本题考查资产要素的定义特征。
...
选项D：成本或价值能够可靠计量是资产的确认条件之一。`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["总论","会计要素的辨析"]},{chapterId:"ch01",sectionId:"s01-04",kpointIds:["kp-ch01-s01-04-x4y2"],type:"single",prompt:"【2.4 计量属性的适用场景】下列各项业务中，应采用历史成本计量的是（ ）。",options:[{id:"A",text:"盘盈的固定资产"},{id:"B",text:"期末存货的可变现净值"},{id:"C",text:"持有待售的非流动资产的公允价值"},{id:"D",text:"可转债中嵌入的衍生工具的公允价值"}],answer:"A",explanation:`本题考查计量属性的应用场景。
...
根据准则规定，固定资产折旧方法属于**会计估计**，因为折旧金额取决于多个会计估计：使用寿命、预计净残值、折旧方法。折旧方法的变更属于**会计估计变更**。`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["总论","可比性的深层理解"]},{chapterId:"ch02",sectionId:"s02-04",kpointIds:["kp-ch02-s02-04-x4y2"],type:"fill",prompt:"【2.1 可变现净值的计算】甲公司为增值税一般纳税人，20×9年12月31日，库存A商品的账面成本为500万元，估计售价为450万元，估计销售费用及相关税费为30万元。A商品是直接用于出售的存货。问：甲公司应对A商品计提多少存货跌价准备？",options:void 0,answer:["80万元","80"],explanation:`可变现净值的计算关键在于区分存货的持有目的：
...
借：资产减值损失——存货跌价损失    80
    贷：存货跌价准备               80
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["存货","可变现净值的计算"]},{chapterId:"ch02",sectionId:"s02-04",kpointIds:["kp-ch02-s02-04-x4y2"],type:"fill",prompt:"【2.2 原材料可变现净值的计算】乙公司20×9年12月31日，库存B原材料的账面成本为300万元，将其用于生产C产品。C产品估计售价为400万元，估计C产品完工尚需投入100万元，估计销售费用及相关税费为20万元。计算B原材料的可变现净值及应计提的存货跌价准备。",options:void 0,answer:["280万元","280","20万元","20"],explanation:`| 步骤 | 计算过程 |
|------|---------|
...
借：存货跌价准备               15
    贷：资产减值损失            15
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["存货","存货跌价准备的转回"]},{chapterId:"ch02",sectionId:"s02-03",kpointIds:["kp-ch02-s02-03-x3y2"],type:"fill",prompt:"【2.5 存货清查盘点的会计处理】戊公司在存货清查中发现盘亏甲材料一批，实际成本30万元，增值税进项税额3.9万元。经查，属于管理不善造成的收发计量差错。保险公司同意赔偿10万元。编制相关会计分录。",options:void 0,answer:[`如上会计分录所示。
...
借：管理费用                    23.9
    其他应收款——保险公司       10
    贷：待处理财产损溢           33.9
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["存货","存货清查盘点的会计处理"]},{chapterId:"ch03",sectionId:"s03-02",kpointIds:["kp-ch03-s03-02-x2y2"],type:"fill",prompt:"【2.1 双倍余额递减法计算】甲公司20×9年12月31日购入一台设备，原值500万元，预计使用年限5年，预计净残值20万元。按双倍余额递减法计算各年折旧额。",options:void 0,answer:["200","120","72","44"],explanation:`双倍余额递减法公式：
...
| 第5年 | 64 | - | 44 | 480 | 20 |`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["固定资产","双倍余额递减法计算"]},{chapterId:"ch03",sectionId:"s03-02",kpointIds:["kp-ch03-s03-02-x2y2"],type:"fill",prompt:"【2.2 年数总和法计算】乙公司购入一台设备，原值300万元，预计净残值15万元，预计使用年限5年。按年数总和法计算各年折旧额。",options:void 0,answer:["95","76","57","38","19"],explanation:`年数总和法公式：
...
| 第3年 | 285 | 3 | 3/15 | 57 |
| 第4年 | 285 | 2 | 2/15 | 38 |
| 第5年 | 285 | 1 | 1/15 | 19 |`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["固定资产","年数总和法计算"]},{chapterId:"ch03",sectionId:"s03-04",kpointIds:["kp-ch03-s03-04-x4y1"],type:"fill",prompt:`【2.3 资本化与费用化的判断】丙公司对下列固定资产后续支出进行判断：
...
| 大修理 | 费用化 | 计入管理费用/销售费用 | 不满足资本化条件 |`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["固定资产","资本化与费用化的判断"]},{chapterId:"ch03",sectionId:"s03-04",kpointIds:["kp-ch03-s03-04-x4y3"],type:"fill",prompt:`【2.4 分期付款购买固定资产（具有融资性质）】丁公司20×9年1月1日从境外购入一台设备，合同约定设备价款1000万元，分5年于每年年末支付200万元。假定购买日的现值为800万元，适用的折现率为10%。
...
借：财务费用（800×10%）          80
    贷：未确认融资费用           80
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["固定资产","分期付款购买固定资产（具有融资性质）"]},{chapterId:"ch03",sectionId:"s03-04",kpointIds:["kp-ch03-s03-04-x4y2"],type:"fill",prompt:"【2.5 固定资产处置的会计处理】戊公司出售一台不需用的机器设备，原价300万元，已累计折旧120万元，已计提减值准备30万元。出售取得价款200万元，适用的增值税率为13%。编制会计分录。",options:void 0,answer:["50万元","50"],explanation:`| 项目 | 计算过程 | 结果 |
|------|---------|------|
...
账面价值 = 500万元
减值 = 500 - 450 = 50万元`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["无形资产","使用寿命不确定的无形资产"]},{chapterId:"ch04",sectionId:"s04-03",kpointIds:["kp-ch04-s04-03-x3y2"],type:"fill",prompt:"【2.5 无形资产处置】甲公司2×23年将一项无形资产出售，该无形资产原值800万元，累计摊销200万元，未计提减值准备。出售价款650万元（不含增值税），增值税率6%。计算出售损益并写出会计分录。",options:void 0,answer:["见解析"],explanation:`账面价值 = 800 - 200 = 600万元
出售价款 = 650万元
增值税 = 650 × 6% = 39万元
资产处置损益 = 650 - 600 = 50万元
...
- 投资收益 = 1800 × 30% = 540万元`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["长期股权投资与合营安排","权益法——投资收益的确认"]},{chapterId:"ch06",sectionId:"s06-03",kpointIds:["kp-ch06-s06-03-x3y2"],type:"fill",prompt:"【2.4 逆流交易未实现内部交易损益】甲持有乙30%股权（权益法）。2026年乙公司向甲公司销售商品，售价600万元，成本400万元。甲公司当年未将该商品对外出售。乙公司2026年实现净利润1500万元。求甲公司2026年应确认的投资收益。",options:void 0,answer:["390","60万元","60"],explanation:`- 未实现内部交易损益 = 600 - 400 = 200万元
- 应抵减的投资收益 = 200 × 30% = 60万元
- 调整后投资收益 = (1500 - 200) × 30% = 390万元`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["长期股权投资与合营安排","逆流交易未实现内部交易损益"]},{chapterId:"ch06",sectionId:"s06-04",kpointIds:["kp-ch06-s06-04-x4y1"],type:"fill",prompt:"【2.5 成本法转权益法（丧失控制权）】甲公司持有乙公司80%股权（成本法），账面价值8000万元。2026年甲公司出售乙公司50%股权（即总股权的50%），取得价款7000万元。剩余30%股权公允价值为4200万元。出售日乙公司可辨认净资产公允价值为13000万元。求确认的投资收益。",options:void 0,answer:["7000","5000","2000","1200"],explanation:`- 丧失控制权，剩余股权按公允价值重新计量
...
借：主营业务成本                80
  贷：库存商品                    80
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["职工薪酬","非货币性福利——自产产品发放"]},{chapterId:"ch09",sectionId:"s09-03",kpointIds:["kp-ch09-s09-03-x3y3"],type:"fill",prompt:"【2.3 设定受益计划】甲公司设定受益计划当期服务成本50万元，利息费用10万元，精算利得5万元。如何处理?",options:void 0,answer:["见解析"],explanation:"当期服务成本+利息费用计入当期损益；精算利得/损失计入其他综合收益\n```\n借：管理费用（当期服务成本50+利息10）  60\n  贷：应付职工薪酬                     60\n借：其他综合收益                     5\n  贷：应付职工薪酬                     5\n```",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["职工薪酬","设定受益计划"]},{chapterId:"ch09",sectionId:"s09-02",kpointIds:["kp-ch09-s09-02-x2y4"],type:"fill",prompt:"【2.4 辞退福利】甲公司辞退50名员工，每人补偿10万元。不论原属哪个部门，全部计入什么科目?",options:void 0,answer:["见解析"],explanation:"辞退福利一律计入管理费用（500万元），不论原属哪个部门。",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["职工薪酬","辞退福利"]},{chapterId:"ch10",sectionId:"s10-02",kpointIds:["kp-ch10-s10-02-x2y1"],type:"single",prompt:"【2.1 权益结算vs现金结算】下列关于权益结算与现金结算股份支付的表述，正确的有（ ）。",options:[{id:"A",text:"1权益结算按授予日公允价值计量"},{id:"B",text:"1现金结算按授予日公允价值计量"},{id:"C",text:"1权益结算确认负债"},{id:"D",text:"1现金结算确认资本公积"}],answer:"A",explanation:"A正确(权益结算按授予日公允价值);1 B错误(现金结算按每期末公允价值重新计量)>1 C错误(权益结算确认权益-资本公积)>1 D错误(现金结算确认负债-应付职工薪酬)",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["股份支付","权益结算vs现金结算"]},{chapterId:"ch10",sectionId:"s10-04",kpointIds:["kp-ch10-s10-04-x4y1"],type:"fill",prompt:"【2.2 1等待期费用分摊】甲公司授予100名员工股票期权，每人100股，授予日公允价值15元/股，等待期3年。第1年末估计90人可行权。2第2年末85人。2第3年末80人。第1年确认费用?",options:void 0,answer:["见解析"],explanation:`第1年费用 = 90人×100股×15元×1/3 = 450,000元
第2年费用 = 85人×100×15×2/3 = 850,000元 - 已确认450,000 = 400,000元
第3年费用 = 80人×100×15×3/3 - 已确认850,000 = 350,000元`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["股份支付","1等待期费用分摊"]},{chapterId:"ch10",sectionId:"s10-03",kpointIds:["kp-ch10-s10-03-x3y1"],type:"fill",prompt:"【2.3 可行权条件——市场条件】甲公司授予期权附带市场条件（股价达到3030元）和非市场条件（净利润增长1010%)>1市场条件未满足时如何处理?",options:void 0,answer:["见解析"],explanation:"1市场条件已计入公允价值,1无论是否满足都不影响确认；1非市场条件未满足→不确认（已确认冲回)。",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["股份支付","可行权条件——市场条件"]},{chapterId:"ch10",sectionId:"s10-01",kpointIds:["kp-ch10-s10-01-x1y1"],type:"fill",prompt:"【2.4 1集团股份支付】1母公司以自身权益工具结算授予子公司员工期权>1子公司如何处理?",options:void 0,answer:["见解析"],explanation:"1子公司确认费用+资本公积；1母公司确认长期股权投资+资本公积",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["股份支付","1集团股份支付"]},{chapterId:"ch10",sectionId:"s10-03",kpointIds:["kp-ch10-s10-03-x3y3"],type:"fill",prompt:"【2.5 1修改条款——不利修改】甲公司将期权行权价格从10元降至8元（有利员工修改)>1如何处理?",options:void 0,answer:["见解析"],explanation:"1不利修改按修改后条款确认>1增加费用部分在修改日至可行权日日之间分摊确认",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["股份支付","1修改条款——不利修改"]},{chapterId:"ch11",sectionId:"s11-02",kpointIds:["kp-ch11-s11-02-x2y1"],type:"fill",prompt:"【2.1 资本化时点判断（单选题）】甲公司为建造一栋办公楼，于2×21年1月1日向银行借入专门借款5,000万元，借款年利率为6%。2×21年3月1日，甲公司以自有资金支付了工程款项2,000万元，同日开始施工建造。下列关于借款费用资本化开始的时点，正确的是（ ）。",options:[{id:"A",text:"2×21年1月1日"},{id:"B",text:"2×21年3月1日"},{id:"C",text:"2×21年1月1日或3月1日均可"},{id:"D",text:"三个条件同时满足后开始资本化"}],answer:["B"],explanation:`借款费用资本化需同时满足三个条件：
1. 资产支出已发生
2. 借款费用已发生
3. 购建活动已开始

本题中，1月1日虽然借款费用已发生，但资产支出（2,000万元）在3月1日才发生。因此，资本化开始时点应为3月1日。`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["借款费用","资本化时点判断（单选题）"]},{chapterId:"ch11",sectionId:"s11-03",kpointIds:["kp-ch11-s11-03-x3y1"],type:"fill",prompt:"【2.2 专门借款利息计算（计算题）】乙公司于2×21年1月1日开始建造一大型设备，当日取得专门借款10,000万元，年利率5%，期限3年。该公司于1月1日、4月1日、7月1日分别支付工程款3,000万元、3,000万元、2,000万元。借款闲置资金在支付工程款前存入银行，月利率0.2%。计算2×21年度应资本化的借款费用金额。",options:void 0,answer:["350万元","350"],explanation:`**第一步：计算实际利息**
\`\`\`
...
\`\`\`
资本化金额 = 500 - 150 = 350万元
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["借款费用","专门借款利息计算（计算题）"]},{chapterId:"ch11",sectionId:"s11-03",kpointIds:["kp-ch11-s11-03-x3y2"],type:"fill",prompt:`【2.3 一般借款利息计算（计算题）】丙公司2×21年度为建造一栋厂房发生如下经济业务：
...
| D | 资金周转困难，属于非正常中断，5个月>3个月 | 暂停 |`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["借款费用","暂停资本化条件（多选题）"]},{chapterId:"ch11",sectionId:"s11-02",kpointIds:["kp-ch11-s11-02-x2y1"],type:"fill",prompt:"【2.5 停止资本化时点（单选题）】下列各项中，应停止借款费用资本化的条件是（ ）。",options:[{id:"A",text:"资产的实体建造工作已全部完成"},{id:"B",text:"资产已达到预定可使用状态，但尚未办理竣工决算"},{id:"C",text:"与设计要求基本相符，但尚有部分细节需要完善"},{id:"D",text:"继续发生在资产上的支出金额很少"}],answer:[`C
...
| D | 金额无法可靠计量，不满足第三个条件 | 否 |`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["或有事项","预计负债确认条件（单选题）"]},{chapterId:"ch12",sectionId:"s12-02",kpointIds:["kp-ch12-s12-02-x2y1"],type:"fill",prompt:`【2.2 最佳估计数计算（计算题）】A公司2×21年度因销售商品承担产品质量保证义务，期末应确认的预计负债金额如下：
- 情形1：共有5,000件产品需要保修，可能发生的保修费用范围为100-200万元，且各金额可能性相同
- 情形2：共涉及5起诉讼案件，最可能赔偿金额分别是50万元、80万元、100万元、150万元、200万元

计算A公司应确认的预计负债金额。`,options:void 0,answer:["1","150万元","150","2","580万元"],explanation:"**情形1：连续范围、等概率**\n```\n最佳估计数 = (上限 + 下限) ÷ 2 = (100 + 200) ÷ 2 = 150万元\n```\n\n**情形2：多个项目，各金额独立**\n```\n预计负债 = 50 + 80 + 100 + 150 + 200 = 580万元\n（分别确认，因为是5起独立的诉讼案件）\n```",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["或有事项","最佳估计数计算（计算题）"]},{chapterId:"ch12",sectionId:"s12-02",kpointIds:["kp-ch12-s12-02-x2y1"],type:"fill",prompt:"【2.3 或有负债vs预计负债（多选题）】下列关于或有事项的表述中，正确的有（ ）。",options:[{id:"A",text:"或有负债包括确认为预计负债的现时义务"},{id:"B",text:"或有资产应在满足条件时确认为资产"},{id:"C",text:"预计负债应该按照最佳估计数计量"},{id:"D",text:"或有负债即使极小可能流出经济利益，企业仍需在附注中披露"}],answer:["C"],explanation:`| 选项 | 判断 | 说明 |
|------|------|------|
| A | 错误 | 或有负债和预计负债是互斥的。预计负债是已确认的，或有负债是未确认的 |
| B | 错误 | 或有资产"不确认"，只能披露；只有基本确定时才能披露 |
| C | 正确 | 预计负债按照最佳估计数计量 |
| D | 错误 | 极小可能（<5%）的或有负债"不需要披露"，其他情形才需要披露 |`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["或有事项","或有负债vs预计负债（多选题）"]},{chapterId:"ch12",sectionId:"s12-02",kpointIds:["kp-ch12-s12-02-x2y1"],type:"fill",prompt:`【2.4 亏损合同会计处理（计算题）】B公司签订了一份不可撤销的销售合同，向客户销售1,000件产品，合同价格100元/件，履行合同估计需发生的成本为120元/件。目前B公司已产成品500件，成本为115元/件，另外500件尚未生产。
...
借：应付债券——可转换公司债券（面值）     100,000
  贷：应付债券——可转换公司债券（利息调整） 14,874.7
      ...
      资本公积——股本溢价                  75,125.3
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["金融工具","金融负债与权益工具区分（计算题）"]},{chapterId:"ch13",sectionId:"s13-04",kpointIds:["kp-ch13-s13-04-x4y3"],type:"fill",prompt:`【2.4 预期信用损失模型（计算题）】B银行2×21年发放了一笔贷款，账面余额10,000万元，年利率5%。2×21年末进行减值评估：
...
选项B说的是资产供出租人使用，这是错误的。租赁是出租人将资产使用权让与承租人，因此资产应该是供**承租人**使用。`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["租赁","租赁识别（单选题）"]},{chapterId:"ch14",sectionId:"s14-02",kpointIds:["kp-ch14-s14-02-x2y1"],type:"fill",prompt:`【2.2 租赁期确定（计算题）】甲公司于2×21年1月1日租入一台设备，租赁合同规定：
- 不可撤销期间：3年（2×21.1.1-2×23.12.31）
- 选择权1：续租2年（每年租金100万元），管理层合理确定会行使
- 选择权2：终止权1年（每年租金80万元），管理层合理确定不会行使

要求：计算该租赁的租赁期。`,options:void 0,answer:["4"],explanation:"**租赁期计算公式：**\n```\n租赁期 = 不可撤销期间 + 合理确定会行使的续租选择权期间 - 合理确定不会行使的终止选择权期间\n```\n\n**本题计算：**\n```\n租赁期 = 3年 + 2年 - 1年 = 4年\n```\n\n**要点提示：**\n- 续租选择权：管理层合理确定会行使 → 纳入租赁期\n- 终止选择权：管理层合理确定不会行使 → 不纳入租赁期",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["租赁","租赁期确定（计算题）"]},{chapterId:"ch14",sectionId:"s14-02",kpointIds:["kp-ch14-s14-02-x2y2"],type:"fill",prompt:`【2.3 承租人初始计量（计算题）】乙公司2×21年1月1日租入一台设备，租赁合同主要条款如下：
...
借：使用权资产                    862.48
  ...
  贷：租赁负债——租赁付款额        1,000
      ...
      预计负债（拆卸费用）          30
      银行存款（租赁激励）         20
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["租赁","承租人初始计量（计算题）"]},{chapterId:"ch14",sectionId:"s14-02",kpointIds:["kp-ch14-s14-02-x2y3"],type:"fill",prompt:`【2.4 承租人后续计量（计算题）】承接上题，假设乙公司采用成本模式对使用权资产进行后续计量，使用权资产按直线法在5年内折旧。计算2×21年度：
（1）使用权资产折旧金额
（2）租赁负债利息费用
...
- 同时确认预计退回商品的成本恢复`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["收入费用和利润","附销售退回条件的销售"]},{chapterId:"ch18",sectionId:"s18-01",kpointIds:["kp-ch18-s18-01-x1y4"],type:"multiple",prompt:"【2.1 是否属于政府补助?】下列属于政府补助的有( )。",options:[{id:"A",text:"增值税出口退税  B. 研发费用加计扣除  C. 财政拨款购置设备  D. 政府作为投资者投入"}],answer:["C"],explanation:"A不属于(退还事先缴纳税); B不属于(直接减征不属于)> C属于(无偿取得货币性资产)> D不属于(政府作为投资者投入=有对价)",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["政府补助","是否属于政府补助?"]},{chapterId:"ch18",sectionId:"s18-02",kpointIds:["kp-ch18-s18-02-x2y1"],type:"fill",prompt:"【2.2 总额法vs净额法】甲公司收到政府补助300万元购置设备(成本1,000万元)> 5年折旧> 1总额法每年确认多少收益?",options:void 0,answer:["见解析"],explanation:`1总额法: 收到300万元→ 1递延收益> 1每年摊销300/5=60万元→ 其他收益
 净额法: 收到300万元冲减设备成本→ 1设备新成本700万元> 1每年折旧140万元(比总额法少60万元)`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["政府补助","总额法vs净额法"]},{chapterId:"ch18",sectionId:"s18-02",kpointIds:["kp-ch18-s18-02-x2y3"],type:"fill",prompt:"【2.3 与收益相关补助】甲公司收到稳岗补贴100万元> 1补偿已发生费用> 1如何处理?",options:void 0,answer:["见解析"],explanation:"1补偿已发生费用→ 1直接计入其他收益(100万元)",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["政府补助","与收益相关补助"]},{chapterId:"ch18",sectionId:"s18-02",kpointIds:["kp-ch18-s18-02-x2y1"],type:"fill",prompt:"【2.4 1退回处理】甲公司退回政府补助50万元> 1原递延收益余额3万元> 1如何处理?",options:void 0,answer:["见解析"],explanation:`1冲减递延收益3万元> 1超出部分(0万元)计入当期损益
1`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["政府补助","1退回处理"]},{chapterId:"ch19",sectionId:"s19-02",kpointIds:["kp-ch19-s19-02-x2y1"],type:"fill",prompt:"【2.1 资产计税基础的计算】甲公司2026年12月31日应收账款账面余额200万元，已计提坏账准备20万元。税法规定坏账准备在实际发生时方可扣除。求应收账款的计税基础及暂时性差异。",options:void 0,answer:["200万元","200","20万元","20","25"],explanation:`- 账面价值 = 200 - 20 = 180万元
- 计税基础 = 200万元（税法不认可坏账准备的扣除）
- 可抵扣暂时性差异 = 200 - 180 = 20万元`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["所得税","资产计税基础的计算"]},{chapterId:"ch19",sectionId:"s19-02",kpointIds:["kp-ch19-s19-02-x2y2"],type:"fill",prompt:"【2.2 负债计税基础的计算】甲公司2026年因产品质量保证计提预计负债50万元，税法规定在实际发生保修费用时方可扣除。求预计负债的计税基础及暂时性差异。",options:void 0,answer:["0万元","0","50万元","50","25"],explanation:`- 账面价值 = 50万元
- 计税基础 = 50 - 50 = 0万元（未来可全额扣除）
- 可抵扣暂时性差异 = 50 - 0 = 50万元`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["所得税","负债计税基础的计算"]},{chapterId:"ch19",sectionId:"s19-05",kpointIds:["kp-ch19-s19-05-x5y2"],type:"fill",prompt:"【2.3 应纳税暂时性差异与递延所得税负债】甲公司一项交易性金融资产成本100万元，年末公允价值130万元。税法以成本计量。求暂时性差异和递延所得税。",options:void 0,answer:["7.5"],explanation:`- 账面价值 = 130万元（公允价值）
- 计税基础 = 100万元（税法按成本）
- 应纳税暂时性差异 = 130 - 100 = 30万元
- 递延所得税负债 = 30 × 25% = 7.5万元`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["所得税","应纳税暂时性差异与递延所得税负债"]},{chapterId:"ch19",sectionId:"s19-05",kpointIds:["kp-ch19-s19-05-x5y1"],type:"fill",prompt:"【2.4 所得税费用的完整计算】甲公司2026年利润总额500万元，当期所得税180万元。年初递延所得税资产15万元，递延所得税负债10万元。年末新增可抵扣暂时性差异40万元，新增应纳税暂时性差异20万元（税率25%）。计算所得税费用。",options:void 0,answer:["180","10","5","500","175"],explanation:`- 递延所得税资产期末 = 15 + 40 × 25% = 25万元
- 递延所得税负债期末 = 10 + 20 × 25% = 15万元
- 递延所得税费用 = (15 - 10) - (25 - 15) = 5 - 10 = -5万元
  即递延所得税收益5万元
- 所得税费用 = 当期所得税 + 递延所得税费用 = 180 - 5 = 175万元`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["所得税","所得税费用的完整计算"]},{chapterId:"ch19",sectionId:"s19-05",kpointIds:["kp-ch19-s19-05-x5y2"],type:"fill",prompt:"【2.5 不确认递延所得税的特殊情形】甲公司发生研发支出200万元（符合加计扣除条件，税法允许按175%扣除）。求是否确认递延所得税资产。",options:void 0,answer:["75万元","75"],explanation:`- 加计扣除部分（75万元）不是暂时性差异，而是永久性差异
- 永久性差异不产生递延所得税`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["所得税","不确认递延所得税的特殊情形"]},{chapterId:"ch20",sectionId:"s20-01",kpointIds:["kp-ch20-s20-01-x1y1"],type:"fill",prompt:"【2.1 25%测试】甲公司以设备(公允500万元)换入材料>1收到补价100万元>1是否属于非货币性资产交换?",options:void 0,answer:["属于"],explanation:"补价100万元÷换出资产公允500万元=20%≤25%→属于非货币性资产交换",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["非货币性资产交换","25%测试"]},{chapterId:"ch20",sectionId:"s20-02",kpointIds:["kp-ch20-s20-02-x2y2"],type:"fill",prompt:"【2.2 商业实质判断】甲公司以设备换入办公楼>1两资产未来现金流风险、时间分布和金额显著不同>1是否具有商业实质?",options:void 0,answer:["具有商业实质+公允可靠计量→公允价值计量"],explanation:"未来现金流显著不同→具有商业实质>1换入资产公允能可靠计量→采用公允价值计量",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["非货币性资产交换","商业实质判断"]},{chapterId:"ch20",sectionId:"s20-03",kpointIds:["kp-ch20-s20-03-x3y1"],type:"fill",prompt:"【2.3 1公允价值计量】甲公司以设备换入办公楼>1设备账面400万元(原价600-1折旧200)>1公允500万元>1办公楼公允500万元>1确认交换损益?",options:void 0,answer:["见解析"],explanation:"交换损益=公允500-账面400=100万元(资产处置损益)",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["非货币性资产交换","1公允价值计量"]},{chapterId:"ch20",sectionId:"s20-03",kpointIds:["kp-ch20-s20-03-x3y2"],type:"fill",prompt:"【2.4 1账面价值计量】甲公司以设备换入办公楼>1不具有商业实质>1设备账面400万元>1换入资产入账价值?",options:void 0,answer:["见解析"],explanation:"换入资产成本=账面400+补价0+税费0=400万元>1不确认交换损益",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["非货币性资产交换","1账面价值计量"]},{chapterId:"ch21",sectionId:"s21-02",kpointIds:["kp-ch21-s21-02-x2y5"],type:"fill",prompt:"【2.1 债务重组方式判断】单选题——下列各项中，不属于债务重组方式的是（ ）",options:[{id:"A",text:"债务人以低于债务账面价值的现金清偿债务"},{id:"B",text:"债务人以公允价值低于债务账面价值的存货清偿债务"},{id:"C",text:"债务人将债务转为权益工具"},{id:"D",text:"债务人发行可转换公司债券"}],answer:[`D
...
选项D"发行可转换公司债券"属于正常融资行为，并非与原债权人重新达成协议，不属于债务重组。`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["债务重组","债务重组方式判断"]},{chapterId:"ch21",sectionId:"s21-02",kpointIds:["kp-ch21-s21-02-x2y1"],type:"fill",prompt:`【2.2 以现金清偿债务的会计处理】计算分析题——甲公司2024年1月1日应收乙公司账款余额为500万元，因乙公司财务困难无法偿还，双方达成债务重组协议：乙公司以银行存款400万元清偿该债务。不考虑相关税费。
...
借：银行存款                    4,000,000
  ...
  贷：应收账款                  5,000,000
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["债务重组","以现金清偿债务的会计处理"]},{chapterId:"ch21",sectionId:"s21-02",kpointIds:["kp-ch21-s21-02-x2y2"],type:"fill",prompt:"【2.3 以非现金资产清偿债务】多选题——关于债务人以非现金资产清偿债务的会计处理，下列说法正确的有（ ）",options:[{id:"A",text:"债务人应按所清偿债务的账面价值与转让资产账面价值之间的差额确认为债务重组利得"},{id:"B",text:"债务人转让的非现金资产公允价值与其账面价值之间的差额，应确认为资产处置损益"},{id:"C",text:"债权人应按放弃债权的账面价值作为受让资产的初始确认金额"},{id:"D",text:"债权人受让多项非现金资产的，应按各项资产的公允价值比例对放弃债权的公允价值进行分配"}],answer:[`A、B、D

---`],explanation:`根据债务重组准则：
- A正确：差额确认债务重组利得
- B正确：非现金资产视同正常出售处理
- C错误：债权人按放弃债权的**公允价值**入账，而非账面价值
- D正确：多项资产按公允价值比例分配`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["债务重组","以非现金资产清偿债务"]},{chapterId:"ch21",sectionId:"s21-02",kpointIds:["kp-ch21-s21-02-x2y3"],type:"fill",prompt:`【2.4 将债务转为权益工具】计算分析题——甲公司应收乙公司账款800万元，乙公司无力偿还，经协商将债务转为乙公司100万股普通股（面值1元/股）。债务重组日乙公司股票的公允价值为6元/股。假定不考虑相关税费。
...
借：长期股权投资                6,000,000
    投资收益                   2,000,000
  贷：应收账款                  8,000,000
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["债务重组","将债务转为权益工具"]},{chapterId:"ch21",sectionId:"s21-02",kpointIds:["kp-ch21-s21-02-x2y4"],type:"fill",prompt:"【2.5 修改债务条款的会计处理】单选题——2024年3月1日，甲公司应收乙公司货款1,000万元，因乙公司资金周转困难，双方达成修改债务条款协议：原债务延期1年，利率降低。重组日修改后的债务公允价值为900万元。甲公司已计提坏账准备50万元。甲公司应确认的投资收益为（ ）万元。",options:[{id:"A",text:"50"},{id:"B",text:"100"},{id:"C",text:"150"},{id:"D",text:"0"}],answer:["1"],explanation:`- 债权账面价值：1,000 - 50 = 950万元
- 修改后债务公允价值：900万元
- 差额：950 - 900 = 50万元
...
选项A、B、C分别涉及境外销售、境外采购、境外融资，都是影响因素。`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["外币折算","记账本位币的确定"]},{chapterId:"ch22",sectionId:"s22-03",kpointIds:["kp-ch22-s22-03-x3y2"],type:"fill",prompt:`【2.2 外币货币性项目的汇兑差额计算】计算分析题——甲公司以人民币为记账本位币，采用当日即期汇率对外币业务进行折算。2024年12月有关业务如下：
...
选项C：购建固定资产——投资活动
选项D：分配现金股利——筹资活动`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["财务报告","现金流量分类"]},{chapterId:"ch23",sectionId:"s23-04",kpointIds:["kp-ch23-s23-04-x4y3"],type:"fill",prompt:`【2.3 间接法调节】计算分析题——甲公司2024年度净利润为8,000,000元。已知：
...
- 减：收益
- 存货减少→加回；存货增加→减去
- 应收增加→减去；应付减少→减去`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["财务报告","间接法调节"]},{chapterId:"ch23",sectionId:"s23-06",kpointIds:["kp-ch23-s23-06-x6y2"],type:"fill",prompt:"【2.4 关联方认定】单选题——下列各项中，不属于甲公司关联方的是（ ）",options:[{id:"A",text:"甲公司的母公司"},{id:"B",text:"甲公司控股50%的子公司"},{id:"C",text:"甲公司的合营企业"},{id:"D",text:"甲公司财务总监的妻子"}],answer:[`D
...
| D | 投资性房地产计量模式变更 | **会计政策变更** | 计量模式是会计确认/计量的基础选择 |`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["会计政策会计估计及其变更和差错更正","会计政策与会计估计的区分"]},{chapterId:"ch24",sectionId:"s24-04",kpointIds:["kp-ch24-s24-04-x4y1"],type:"fill",prompt:`【2.2 会计政策变更的追溯调整法】计算分析题——甲公司2024年1月1日起，将发出存货的计价方法由先进先出法（FIFO）改为月末一次加权平均法。假设：
...
借：盈余公积                   8
    利润分配——未分配利润    72
  贷：利润分配——未分配利润（调整） 80
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["会计政策会计估计及其变更和差错更正","会计政策变更的追溯调整法"]},{chapterId:"ch24",sectionId:"s24-04",kpointIds:["kp-ch24-s24-04-x4y2"],type:"fill",prompt:"【2.3 会计估计变更的未来适用法】单选题——2024年1月1日，甲公司将一项管理用固定资产的折旧年限由10年改为8年。该固定资产原值500万元，预计净残值为0，原折旧年限10年，已使用3年。假设按年限平均法计提折旧，变更当日，甲公司应（ ）",options:[{id:"A",text:"将剩余折旧年限调整为5年，当年多提折旧100万元"},{id:"B",text:"将剩余折旧年限调整为5年，当年按新折旧额计提折旧"},{id:"C",text:"将剩余折旧年限调整为7年，当年多提折旧50万元"},{id:"D",text:"将剩余折旧年限调整为7年，当年按新折旧额计提折旧"}],answer:["5"],explanation:`**变更前：**
- 年折旧额 = 500/10 = 50万元
- 已提折旧 = 50×3 = 150万元
- 账面价值 = 500 - 150 = 350万元
...
- 原折旧额 = 50万元
- 新折旧额 = 70万元
- 多提折旧 = 20万元`,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["会计政策会计估计及其变更和差错更正","会计估计变更的未来适用法"]},{chapterId:"ch24",sectionId:"s24-05",kpointIds:["kp-ch24-s24-05-x5y2"],type:"fill",prompt:`【2.4 前期重大差错的追溯重述】计算分析题——甲公司在2024年发现2023年漏记了一项固定资产的折旧300万元（属于重要差错），适用所得税税率25%，公司按10%提取盈余公积。2023年该固定资产未对外出售。
...
借：预计负债                5,000,000
  贷：银行存款              5,000,000
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["资产负债表日后事项","诉讼案件结案的调整处理"]},{chapterId:"ch25",sectionId:"s25-02",kpointIds:["kp-ch25-s25-02-x2y1"],type:"fill",prompt:`【2.3 销售退回的调整处理】计算分析题——甲公司2024年12月20日销售商品一批，售价200万元（不含税），成本150万元。款项已收取。2025年3月5日（财务报告批准报出日前），因质量问题该批商品被全部退回。甲公司适用增值税税率13%，所得税税率25%，按净利润10%计提盈余公积。
...
借：盈余公积                    37,500
    利润分配——未分配利润      337,500
  贷：以前年度损益调整         375,000
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["资产负债表日后事项","销售退回的调整处理"]},{chapterId:"ch25",sectionId:"s25-02",kpointIds:["kp-ch25-s25-02-x2y2"],type:"fill",prompt:`【2.4 利润分配方案的处理】多选题——甲公司2025年3月20日（财务报告批准报出日前）董事会作出如下决议：
...
借：净资产（乙公司，公允）  6000
  ...
  贷：长期股权投资  5000
      少数股东权益  1200（6000×20%）
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["合并财务报表","非同一控制购买日抵销"]},{chapterId:"ch27",sectionId:"s27-05",kpointIds:["kp-ch27-s27-05-x5y1"],type:"fill",prompt:"【2.2 内部存货交易抵销（当期）】甲向乙销售商品，售价400万元，成本300万元。乙当年将该商品的60%对外出售，40%形成期末存货。",options:void 0,answer:["400","40","100","360"],explanation:`答案：\`\`\`
// 抵销内部销售收入和成本
借：营业收入  400
  贷：营业成本  400
...
借：营业收入  400
  贷：营业成本  360
      存货  40
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["合并财务报表","内部存货交易抵销（当期）"]},{chapterId:"ch27",sectionId:"s27-05",kpointIds:["kp-ch27-s27-05-x5y2"],type:"fill",prompt:"【2.3 连续编制合并报表——内部存货交易】上年甲向乙销售商品，售价400万元，成本300万元，乙年末仍有40%未售。本年乙将上年剩余存货全部售出，且本年甲又向乙销售商品，售价500万元，成本350万元，乙年末仍有30%未售。",options:void 0,answer:["40","500","45","150","30"],explanation:`答案：\`\`\`
...
借：营业成本  45（150×30%）
  贷：存货  45
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["合并财务报表","连续编制合并报表——内部存货交易"]},{chapterId:"ch27",sectionId:"s27-05",kpointIds:["kp-ch27-s27-05-x5y1"],type:"fill",prompt:"【2.4 内部固定资产交易抵销】甲向乙销售一台设备，售价600万元，成本400万元。乙将该设备作为管理用固定资产，按5年直线法折旧，残值为0。",options:void 0,answer:["600","400","200","5","40万元"],explanation:`答案：\`\`\`
// 抵销内部销售
借：营业收入  600
  贷：营业成本  400
      固定资产——原价  200
...
借：固定资产——累计折旧  40（本年）
  贷：管理费用  40
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["合并财务报表","内部固定资产交易抵销"]},{chapterId:"ch27",sectionId:"s27-05",kpointIds:["kp-ch27-s27-05-x5y1"],type:"fill",prompt:"【2.5 内部债权债务抵销】甲应收乙200万元，乙应付甲200万元。甲对该应收账款计提坏账准备10万元。",options:void 0,answer:["200","10","2.5","25"],explanation:`答案：\`\`\`
// 抵销债权债务
借：应付账款  200
  贷：应收账款  200
...
借：递延所得税资产  2.5（10×25%）
  贷：所得税费用  2.5
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["合并财务报表","内部债权债务抵销"]},{chapterId:"ch28",sectionId:"s28-01",kpointIds:["kp-ch28-s28-02-x2y1"],type:"fill",prompt:"【2.1 1基本EPS】甲公司净利润500万元>1发行在外普通股1,000万股>1 2x23年4月1日新增发行200万股>1基本EPS?",options:void 0,answer:["见解析"],explanation:"加权平均股数=1,000+200×912=1,000×812=1,200万股> 1基本EPS=500/1,200=00.417元",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["每股收益","1基本EPS"]},{chapterId:"ch28",sectionId:"s28-03",kpointIds:["kp-ch28-s28-03-x3y3"],type:"fill",prompt:"【2.2 1稀释EPS—可转债】甲公司净利润500万元>1加权股数1,000万股>1发行可转债(面值1,000万元>1利率55%)>1可转100万股>1稀释EPS?",options:void 0,answer:["见解析"],explanation:"分子: 500+1,000×5%×(1-25%)=500+37.5=537.5万元> 1分母: 1,000+100=1,100万股> 1稀释EPS=537.5/1,100=00489元> 1低于0.417→具有稀释性",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["每股收益","1稀释EPS—可转债"]},{chapterId:"ch28",sectionId:"s28-02",kpointIds:["kp-ch28-s28-02-x2y2"],type:"fill",prompt:"【2.3 1认股权证(无对价股数)】甲公司发行认股权证>1行权价86元>1平均股价1010元>1拟行权100万股>1增加股数?",options:void 0,answer:["见解析"],explanation:"无对价股数=100-(6×100/10)=100-60=40万股",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["每股收益","1认股权证(无对价股数)"]},{chapterId:"ch28",sectionId:"s28-03",kpointIds:["kp-ch28-s28-03-x3y3"],type:"fill",prompt:"【2.4 反稀释性判断】1稀释EPS>基本EPS时→是否纳入稀释计算?",options:void 0,answer:["见解析"],explanation:"不纳入>1增加EPS的不具有稀释性",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["每股收益","反稀释性判断"]},{chapterId:"ch28",sectionId:"s28-04",kpointIds:["kp-ch28-s28-04-x4y1"],type:"fill",prompt:"【2.5 1重新计算(配股)】甲公司配股>1每10股配3股>1配股价86元>1行权前公允1010元>1调整系数?",options:void 0,answer:["见解析"],explanation:"1理论除权价=(10×10+3×6)/13=98.46元> 1调整系数=10/8.46=1.05> 1",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["每股收益","1重新计算(配股)"]},{chapterId:"ch29",sectionId:"s29-02",kpointIds:["kp-ch29-s29-02-x2y4"],type:"fill",prompt:"【2.1 公允价值定义】公允价值的核心假设包括?",options:void 0,answer:["见解析"],explanation:"有序交易(非被迫)+1主要市场或最有利市场+1市场参与者视角",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["公允价值计量","公允价值定义"]},{chapterId:"ch29",sectionId:"s29-02",kpointIds:["kp-ch29-s29-02-x2y2"],type:"fill",prompt:"【2.2 估值技术选择】优先使用哪种估值技术?",options:void 0,answer:["见解析"],explanation:"市场法(利用市场报价)>1收益法(DCF)>1成本法(重置成本)",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["公允价值计量","估值技术选择"]},{chapterId:"ch29",sectionId:"s29-02",kpointIds:["kp-ch29-s29-02-x2y4"],type:"multiple",prompt:"【2.3 公允价值层次】下列属于第一层次输入值的有（ )。",options:[{id:"A",text:"上市公司股票收盘价  B. 类似资产交易价格  C. 管理层预测数据  D. 活跃市场债券报价"}],answer:["A","D"],explanation:"A和D是第一层次(活跃市场报价)>1 B是第二层次(可观察非活跃)>1 C是第三层次(不可观察)",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["公允价值计量","公允价值层次"]},{chapterId:"ch29",sectionId:"s29-01",kpointIds:["kp-ch29-s29-01-x1y1"],type:"fill",prompt:"【2.4 交易费用】交易费用是否计入公允价值?",options:void 0,answer:["见解析"],explanation:"不计入>1交易费用属于增量成本>1计入资产/负债成本但不计入公允价值",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["公允价值计量","交易费用"]},{chapterId:"ch29",sectionId:"s29-01",kpointIds:["kp-ch29-s29-01-x1y1"],type:"fill",prompt:"【2.5 最佳用途】一块土地当前作为停车场>1但最佳用途是商业开发>1公允价值按哪个用途确定?",options:void 0,answer:["见解析"],explanation:"按最佳用途(商业开发)确定公允价值>1即使当前用途不同",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["公允价值计量","最佳用途"]},{chapterId:"ch30",sectionId:"s30-01",kpointIds:["kp-ch30-s30-01-x1y1"],type:"fill",prompt:"【2.1 1双体系】政府会计由哪些体系构成?",options:void 0,answer:["见解析"],explanation:"预算会计(收付实现制)+1财务会计(权责发生制)>1双功能、1双基础、1双报告",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["政府及民间非营利组织会计","1双体系"]},{chapterId:"ch30",sectionId:"s30-02",kpointIds:["kp-ch30-s30-02-x2y1"],type:"fill",prompt:"【2.2 1财政直接支付】1某事业单位通过财政直接支付购买设备10万元>1写出双分录",options:void 0,answer:["见解析"],explanation:`\`\`\`
财务会计:
借:固定资产               10
  贍:财政拨款收入             10
预算会计:
借:事业支出               10
  贍:财政拨款预算收入         10
\`\`\``,difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["政府及民间非营利组织会计","1财政直接支付"]},{chapterId:"ch30",sectionId:"s30-02",kpointIds:["kp-ch30-s30-02-x2y1"],type:"fill",prompt:"【2.3 1限定性收入】1某基金会收到捐赠50万元>1捐赠人限定用于助学项目>1如何分类?",options:void 0,answer:["见解析"],explanation:"1限定性收入(限制在以后期间满足)>1如果限制在本期满足→非限定性收入",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["政府及民间非营利组织会计","1限定性收入"]},{chapterId:"ch30",sectionId:"s30-02",kpointIds:["kp-ch30-s30-02-x2y4"],type:"fill",prompt:"【2.4 预算结转结余】区分财政拨款结转与财政拨款结余?",options:void 0,answer:["见解析"],explanation:"1结转=未使用完毕需结转下年继续使用>1结余=1项目已完成或终止的剩余",difficulty:2,source:"笔记 INTERMEDIATE 改编",tags:["政府及民间非营利组织会计","预算结转结余"]}];function gn(){return jn.map(n=>({id:ge(),chapterId:n.chapterId,sectionId:n.sectionId,kpointIds:n.kpointIds,type:n.type,prompt:n.prompt,options:n.options,answer:n.answer,explanation:n.explanation,difficulty:n.difficulty??2,source:n.source,tags:n.tags,bookmarked:0,createdAt:t(),updatedAt:t()}))}const ye=[{id:"mat-01-02-a",chapterId:"ch01",sectionId:"s01-02",prompt:`甲公司为一般纳税人，2026 年 1 月发生下列经济业务（不考虑增值税）：
